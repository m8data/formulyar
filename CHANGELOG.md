...
## [0.0.5] - 2016-09-12
### Изменения
- Добавление возможности функционирования фреймворка внутри подпапок сайта и соответствующие изменения в документации
- Добавление в инструкцию пункта 6 (установление прав на исполнение для reg.pl)
