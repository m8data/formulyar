...
- Платформа после коммита: хук post-receive клонирует или обновляет ветку репозитория в /home/git/_[branche]/[rep]
- Платформа после коммита: скрипт reg.pl создает или обновляет индекс ветки при первом обращении к ней из web
