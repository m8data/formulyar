...
- Платформа после коммита: хук post-receive автоматически клонирует или обновляет ветку репозитория в /home/git/_[branche]/[rep]
- Платформа после коммита: переиндексирование ветки на сервере при первом обращении к ней
